	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/#"><img src="/img/logo_polije.png" data-active-url="img/logo_polije_black.png" alt=""></a>
			</div>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<h1 class="white typed">Di Dashboard Portofolio Ryan</h1>
					...
					<div class="team text-center">
						<div class="cover" style="background:url('img/team/team-cover1.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">Project Manager</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="/img/team/ryan.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Syarif</h4>
							<h5 class="muted regular">Project Manager</h5>
						</div>
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('img/team/team-cover2.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">Developer</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="/img/team/adek.png" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Hani'atul Khoiriyah</h4>
							<h5 class="muted regular">Developer</h5>
						</div>
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('img/team/team-cover3.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">Software Testing</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="/img/team/ryan.jpg" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Januriansyah</h4>
							<h5 class="muted regular">Software Testing</h5>
						</div>
						<a href="/#" data-toggle="modal" data-target="#modal1" class="btn btn-blue-fill ripple">Sign Up Now</a>
					</div>
				</div>
